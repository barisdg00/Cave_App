...
class _IhracatPuaniEkraniState extends State<IhracatPuaniEkrani> {
  ...
  Widget _statKart(String baslik, String deger, IconData icon, Color renk) {
    return Expanded(
      child: Container(
          ...
          Row(
            children: [
              Expanded(
                child: _maliKart(
                  t('Maliyet'),
                  '₺${p.toplamMaliyet.toStringAsFixed(2)}',
              ...
              Expanded(
                child: _maliKart(
                  t('Tah. Satış'),
                  '₺${p.tahminiToplamGelir.toStringAsFixed(2)}',
                  AppTheme.accentColor,
                ),
              ),
              const SizedBox(width: 8),
              Expanded(
                child: _maliKart(
                  t('Tah. Kar'),
                  '₺${p.tahminiKar.toStringAsFixed(2)}',
                  p.tahminiKar >= 0
  ...
  Widget _maliKart(String baslik, String deger, Color renk) {
    return Container(
